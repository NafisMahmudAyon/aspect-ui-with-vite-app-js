	...
	({ children, asChild, className = "", ...props }, ref) => {
		...
		return (
			<button
				...
				ref={ref}
				className={cn(
					"inline-flex items-center justify-center border border-border rounded-full size-[2rem] text-text bg-bg-light disabled:opacity-50 disabled:pointer-events-none",
					className
				)}
				type="button">
				{!children && (
